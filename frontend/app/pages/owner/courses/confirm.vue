  ...
  <section class="text-gray-600 body-font relative">
    <div class="container px-5 py-24 mx-auto">
      ...
      <div v-if="!form" class="text-center text-red-600">
        データが見つかりません。
        <NuxtLink to="/owner/courses/create" class="text-blue-600 underline ml-2">
          入力画面に戻る
        </NuxtLink>
      </div>
...
const backToEdit = () => {
  navigateTo('/owner/courses/create')
}
